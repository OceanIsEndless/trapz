...
var jsembed = function()
{
	...
	*/      
	...
	function embedCSS() 
	{
		...
		tStyle.setProperty("-ms-touch-action", "auto", null);
	}
	/*
	...
	function embedMetaTags() 
	{
		...
		addMetaTag(metaViewPortSetting, "true");
	...
	function embedCustomAPIMain(tar, app)
	{
		...
		{
			case API_HAXE_NME:
				tar.setAttribute("style", "background-color: #000000;	position: absolute; left: 50%;	" + (attributes.autoscale=="false"?"margin-left:-512px;":"padding:0;") +	"-webkit-user-select: none; -ms-touch-action:auto;	overflow: hidden; width:"+widthIdeal+"px;	height:"+heightIdeal+"px; -webkit-tap-highlight-color: rgba(0,0,0,0); data-framerate:30;");
				targetId = "haxe:jeash";
				...
				return true;
			case API_HAXE_FLAMBE:
				var useWidth = widthIdeal;
				var prcWidth = 1;
				/*if(typeof $("#"+targetId).parent() != undefined&&$("#"+targetId).parent() !=null)
				{
					useWidth = $("#"+targetId).parent().width();
					
					prcWidth = useWidth/widthIdeal;
				}*/
				
				tar.setAttribute("style", "background-color: #000000;padding:0;-webkit-user-select: none; -ms-touch-action:auto;	overflow: hidden; width:"+useWidth+"px;	height:"+heightIdeal+"px; -webkit-tap-highlight-color: rgba(0,0,0,0); data-framerate:30;");
				embedScalingScript();
				win.flambe.embed([base+"targets/main-html.js", base+"targets/main-flash.swf"], targetId );			
				return false;
			case API_CONSTRUCT_2:				
